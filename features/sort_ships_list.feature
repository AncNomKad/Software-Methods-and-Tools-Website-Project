Feature: display table of ships that sort by title, class, and manufacturer

As an avid lover for Freespace
So that I can quickly browse ships based on my preferences
I want to see moves sorted by title, or class, or manufacturer
...
Scenario: sort ships alphabetically by title

Scenario: sort ships alphabetically by class

Scenario: sort ships alphabetically by manufacturer